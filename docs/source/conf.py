...
html_theme_options = {
    ...
    "light_css_variables": {
        ...
        "color-background-hover--transparent": "#33415580",
        ...
        "color-highlight-on-target": "#1e3a5f",
        "color-api-background": "#1e293b",
        "color-api-background-hover": "#334155",
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/kevinkorfmann/fastcxt",
...
# Custom CSS for extra dark-mode polish
